...
public class CWE81_XSS_Error_Message__Servlet_PropertiesFile_52a extends AbstractTestCaseServlet
{
    ...
    public void bad(HttpServletRequest request, HttpServletResponse response) throws Throwable
    {
        ...
        (new CWE81_XSS_Error_Message__Servlet_PropertiesFile_52b()).bad_sink(data , request, response);
    }
    ...
    private void goodG2B(HttpServletRequest request, HttpServletResponse response) throws Throwable
    {
        ...
        (new CWE81_XSS_Error_Message__Servlet_PropertiesFile_52b()).goodG2B_sink(data , request, response);
    }
